...
if (isset($_POST['tombol'])) {
  if ($_POST['tombol'] == 'simpanAkun') {
    ...
    $email = $_POST['email'];
    // query create
    mysqli_query($koneksi, "INSERT INTO dosen VALUES('$nip','$gelar_depan','$nama','$gelar_belakang','$email')");
    if (mysqli_affected_rows($koneksi) > 0)
      echo '<div class="alert alert-success" style="
          ...
          left: 50%;
          transform: translateX(-50%);
          "><strong>Berhasil</strong> menambahkan Dosen!</div>';
    else
      echo '<div class="alert alert-danger" style="
          ...
          left: 50%;
          transform: translateX(-50%);
          "><strong>Gagal</strong> menambahkan Dosen!</div>';
    $status_nip = "";
    $tombol_val = "simpan";
    $nip = "";
    $gelar_depan = "";
    ...
    $email = $_POST['email'];
    //query update
    mysqli_query($koneksi, "UPDATE dosen SET gelar_depan='$gelar_depan', nama='$nama', gelar_belakang='$gelar_belakang', email='$email' WHERE nip='$nip'");
    if (mysqli_affected_rows($koneksi) > 0) {
      echo '<div class="alert alert-success" style="
          max-width: 50%;
          z-index: 999999999999;
          ...
          text-align:center;
          transform: translateX(-50%);
          "><strong>Berhasil</strong> mengubah data Dosen!</div>';
      $tombol_val = "simpan";
      $cardHeader = "Tambah";
      $status_nip = "";
      $nip = "";
      ...
      echo '<div class="alert alert-danger" style="
          ...
          text-align:center;
          transform: translateX(-50%);
          "><strong>Gagal</strong> mengubah data Dosen!</div>';
      $status_nip = "readonly";
      $tombol_val = "edit";
      $cardHeader = "Edit";
    }
    ...
    echo '<div class="alert alert-success" style="
          ...
          text-align:center;
          transform: translateX(-50%);
          "><strong>Berhasil</strong> menghapus Dosen!</div>';
    $nip = "";
    $gelar_depan = "";
    $nama = "";
    $gelar_belakang = "";
